object Versions {
    ...
    val junit = "4.13"
    val material = "1.2.1"
    val multiplatform_settings = "0.6.3"
...
object Deps {
    ...
    val multiplatformSettings = "com.russhwolf:multiplatform-settings:${Versions.multiplatform_settings}"
    val multiplatformSettingsTest = "com.russhwolf:multiplatform-settings-test:${Versions.multiplatform_settings}"
    ...
    object SqlDelight {
        val gradle = "com.squareup.sqldelight:gradle-plugin:${Versions.sql_delight}"
        val runtime = "com.squareup.sqldelight:runtime:${Versions.sql_delight}"
        val runtimeJdk = "com.squareup.sqldelight:runtime-jvm:${Versions.sql_delight}"
        val driverIos = "com.squareup.sqldelight:native-driver:${Versions.sql_delight}"
        val driverAndroid = "com.squareup.sqldelight:android-driver:${Versions.sql_delight}"
    }
